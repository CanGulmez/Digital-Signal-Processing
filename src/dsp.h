...
extern void dsp_time_resize(const DspTime *sample, DspLen length, DspTime *result);
...
extern void dsp_time_rand(DspLen length, DspTime *result);
extern void dsp_time_randn(DspLen length, DspTime *result); 
extern DspLen dsp_time_length(const DspTime *sample);
...
extern void dsp_freq_resize(const DspFreq *sample, DspLen length, DspFreq *result);
...
extern DspLen dsp_freq_length(const DspFreq *sample);
...
extern void __plot_label_x(GtkDrawingArea *area, cairo_t *cr, DspLen length, int width, int height);
extern void __plot_label_y(GtkDrawingArea *area, cairo_t *cr, int width, int height);
extern void __plot_indices(GtkDrawingArea *area, cairo_t *cr, DspPlot *plot, int width, int height);
extern void __plot_color_to_rgb(DspColor color, double rgb[3]);
extern void __plot_sample_data(GtkDrawingArea *area, cairo_t *cr, DspPlot *plot, int width, int height);
...
extern void dsp_signal_normal(double mean, double stddev, DspLen length, DspTime *result);
extern void dsp_signal_awgn(const DspTime *sample, double snr, DspTime *result);
extern void dsp_signal_sin(double A, double fc, double fs, double theta, DspLen length, DspTime *result);
extern void dsp_signal_sinc(double A, double fc, double fs, double theta, DspLen length, DspTime *result);
extern void dsp_signal_cos(double A, double fc, double fs, double theta, DspLen length, DspTime *result);
extern void dsp_signal_impulse(int index, DspLen length, DspTime *result);
extern void dsp_signal_step(double A, int fsample, int ssample, DspLen length, DspTime *result);
extern void dsp_signal_square(double A, double fc, double fs, DspLen length, DspTime *result);
extern void dsp_signal_sawtooth(double A, double fc, double fs, DspLen length, DspTime *result);
extern void dsp_signal_triangle(double A, double fc, double fs, DspLen length, DspTime *result);
